...
.data
    ...
    errorImport:
        .asciz "Error en el Comando De YLOGICO en la letra Y"
    ...
    readSuccess:
        .asciz "La operacion YLOGICO se ha realizado Correctamente\n"
...
cargar_referencia:
    ...
    sumar_variables:
        ...
        IF:
            ...
            IF_ANIDADO:
                AND x4, x0, x3 //Se realiza la resta de num - num6
                B salida //Saltamoa a cargar el numero
            ELSE_ANIDADO:
                AND x4, x0, x2 //Se realiza la resta de num - num5
                B salida //Saltamoa a cargar el numero
        ELSE:
            CMP x3, 0 //Comparamos num6 con el valor de cero
            ...
            IF_ANIDADO2:
                AND x4, x1, x3 //Se realiza la resta de num4 - num6
                B salida //Saltamoa a cargar el numero
            ELSE_ANIDADO2:
                AND x4, x1, x2 //Se realiza la resta de num4 - num5
                B salida //Saltamoa a cargar el numero
