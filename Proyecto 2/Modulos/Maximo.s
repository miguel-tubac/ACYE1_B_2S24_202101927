...
.data
    ...
    errorImport:
        .asciz "Error en el Comando De MAXIMO o en la letra HASTA"
    ...
    readSuccess:
        .asciz "La operacion MAXIMO se ha realizado Correctamente\n"
    ...
    mostrar_celdas:
        ...
        inicio_loop1:
            ...
            loop_imprimir1:
                ...
                CMP w10, w9
                BLE IF        // Si valor anterior <= valor actual saltar 
                B esle
        ...
        inicio_loop2:
            ...
            loop_imprimir2:
                ...
                CMP w10, w9
                BLE IF2        // Si valor anterior <= valor actual saltar 
                B esle2
