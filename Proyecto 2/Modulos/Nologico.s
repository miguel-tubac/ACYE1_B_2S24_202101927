...
.data
    ...
    errorImport:
        .asciz "Error en el Comando De NOLOGICO"
    ...
    readSuccess:
        .asciz "La operacion NOLOGICO se ha realizado Correctamente\n"
...
proc_import:
    ...
    imp_filename: //Esta etiqueta obtiene el nombre de la etiqueta o el valor numerico
        ...
        imp_file_loop:
            ...
            CBZ w2, end_proc_import //Comparar y saltar si es cero, es decir un espacio en blanco
...
cargar_referencia:
    ...
    sumar_variables:
        ...
        IF:
            MVN x4, x0 //Se realiza la resta de not(num)
            B salida //Saltamoa a cargar el numero
        ELSE:
            MVN x4, x1 //Se realiza la resta de not(num4)
            B salida //Saltamoa a cargar el numero
