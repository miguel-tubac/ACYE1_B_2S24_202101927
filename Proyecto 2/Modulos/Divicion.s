...
.data
    ...
    errorImport:
        .asciz "Error en el Comando De DIVIDIR en la letra ENTRE"
    ...
    readSuccess:
        .asciz "La operacion DIVIDIR se ha realizado Correctamente\n"
...
cargar_referencia:
    ...
    sumar_variables:
        ...
        IF:
            ...
            CMP x2, 0 //Comparamos num5 con el valor de cero
            BNE ELSE_ANIDADO //Si num5 != 0 saltar a ELSE_ANIDADO
            B error_denominador //Si num6 == 0 || num5 == 0 saltar a error

            IF_ANIDADO:
                SDIV w4, w0, w3 //Se realiza la resta de num - num6
                B salida //Saltamoa a cargar el numero
            ELSE_ANIDADO:
                SDIV w4, w0, w2 //Se realiza la resta de num - num5
                B salida //Saltamoa a cargar el numero
        ELSE:
            CMP x3, 0 //Comparamos num6 con el valor de cero
            BNE IF_ANIDADO2 //Si num6 != 0 saltar a IF_ANIDADO2
            CMP x2, 0 //Comparamos num5 con el valor de cero
            BNE ELSE_ANIDADO2 //Si num5 != 0 saltar a ELSE_ANIDADO2
            B error_denominador //Si num6 == 0 || num5 == 0 saltar a error

            IF_ANIDADO2:
                SDIV w4, w1, w3 //Se realiza la resta de num4 - num6
                B salida //Saltamoa a cargar el numero
            ELSE_ANIDADO2:
                SDIV w4, w1, w2 //Se realiza la resta de num4 - num5
                B salida //Saltamoa a cargar el numero

        error_denominador:
            print 1, denominador, lenDeno //Imprime un mensaje de error por devidir entre cero
            read 0, character, 2    // Leer dos caracteres de entrada
